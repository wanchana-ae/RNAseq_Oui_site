...
countData <- as.matrix(read.table("gene_count_matrix.csv", sep=',', row.names = 1, header = 1))
head(countData)
colData <- read.csv("sample_list_DESeq2.txt", sep="\t", row.names=1, stringsAsFactors = 1)
